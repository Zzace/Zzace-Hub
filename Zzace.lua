...
spawn(function() 
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=yellow>THÔNG BÁO:Hub Này Đã Hết HạnHạn<Color=/>"):Display()
    wait(2)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Đã Phát Hiện Gian Lận!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Đã Phát Hiện Gian Lận!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Đã Phát Hiện Gian Lận!<Color=/>"):Display()
