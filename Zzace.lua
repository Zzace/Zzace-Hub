...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO Almace Hub<Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=YYellow> THÔNG BÁO:Hub Này Đã Hết Hạn <Color=/>"):Display()
    wait(44)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Đã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Re>Đã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Đã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Re>Đã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=Re>Đã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>ĐĐã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Re>Đã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
    wait(1)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Đã Phát Hiện Gian Lận Trò Chơi!<Color=/>"):Display()
...
local Window = Fluent:CreateWindow({
    Title = "Zzace HUB | ".._G.Version,
    SubTitle = "Games: BloxFruit",
    TabWidth = 80,
